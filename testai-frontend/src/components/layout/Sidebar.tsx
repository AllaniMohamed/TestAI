...
const Sidebar: React.FC<SidebarProps> = ({ isOpen = false, onClose }) => {
  ...
  return (
    <>
      {/* Version mobile : panneau glissant */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200/60 transform transition-transform duration-300 ease-in-out md:hidden ${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          {/* Navigation mobile (identique, avec fermeture au clic) */}
      ...
      {/* Version desktop : visible en permanence */}
